...
public final class SunshineDateUtils {
    ...
    private static String getDayName(Context context, long dateInMillis) {
        ...
        String providedDay = dayFormat.format(dateInMillis);
        String today = dayFormat.format(System.currentTimeMillis());
        String tomorrow = dayFormat.format(System.currentTimeMillis() + DAY_IN_MILLIS);


        if (providedDay.equals(today)) return  context.getString(R.string.today);
        if (providedDay.equals(tomorrow)) return  context.getString(R.string.tomorrow);
...
//            case dayFormat.format(System.currentTimeMillis() + DAY_IN_MILLIS):
